...
chip_add_extra_library(chipPlatform)
...
target_link_directories(chipPlatform INTERFACE
...
target_sources(chipPlatform INTERFACE
...
target_compile_options(chipPlatform INTERFACE
    ${COMMON_OPTIONS}
)
target_link_options(chipPlatform INTERFACE
    ${COMMON_OPTIONS}
    -Wl,--gc-sections
    -T${LINKER_SCRIPT}
)
...
#
# Disable CHIP library build by default.
#
# The reason is that various examples have a custom app_config.h file and different
# permutations of those configurations may break compatibility between modules.
#
option(CHIP_BUILD_LIBRARY "Build CHIP library" OFF)
